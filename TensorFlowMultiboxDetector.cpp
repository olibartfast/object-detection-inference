...
Status TensorFlowMultiboxDetector::ReadTensorFromImageFile(const string& file_name, const int input_height,
...
Status TensorFlowMultiboxDetector::SaveImage(const Tensor& tensor, const string& file_path){
...
// can use to run it.
Status TensorFlowMultiboxDetector::LoadGraph(const string& graph_file_name,
                 std::unique_ptr<tensorflow::Session>* session) {
...
Status TensorFlowMultiboxDetector::GetTopDetections(const std::vector<Tensor>& outputs, int how_many_labels,
...
// box priors.
void TensorFlowMultiboxDetector::DecodeLocation(const float* encoded_location, const float* box_priors,
...
void TensorFlowMultiboxDetector::DrawBox(const int image_width, const int image_height, int left, int top,
...
Status TensorFlowMultiboxDetector::PrintTopDetections(const std::vector<Tensor>& outputs,
